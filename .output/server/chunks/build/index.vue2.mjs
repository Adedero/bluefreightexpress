...
import { p as priorities, o as orderStatuses, f as freightModes, d as deliveryModes } from './index.mjs';
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_PrimeStepPanel, null, {
                    default: withCtx(({ activateCallback }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="bg-[--p-surface-50] rounded-md p-2 grid gap-4"${_scopeId3}><div class="grid md:grid-cols-2 lg:grid-cols-4 gap-2"${_scopeId3}><div class="grid form-control"${_scopeId3}><label${_scopeId3}>Priority <span class="text-red-500"${_scopeId3}>*</span></label>`);
                        _push4(ssrRenderComponent(_component_PrimeSelect, {
                          modelValue: unref(order).priority,
                          "onUpdate:modelValue": ($event) => unref(order).priority = $event,
                          options: unref(priorities)
                        }, null, _parent4, _scopeId3));
                        _push4(`</div><div class="grid form-control"${_scopeId3}><label${_scopeId3}>Order Status <span class="text-red-500"${_scopeId3}>*</span></label>`);
                        _push4(ssrRenderComponent(_component_PrimeSelect, {
                        ...
                        _push4(ssrRenderComponent(_component_PrimeButton, {
                          ...
                          icon: "pi pi-arrow-right",
                          "icon-pos": "right",
                          disabled: !unref(order).priority || !unref(order).status || !unref(order).deliveryMode || !unref(order).freightMode
                        }, null, _parent4, _scopeId3));
                        _push4(`</div></div>`);
                      } else {
                        return [
