...
import { p as script$l, B as BaseStyle, w as script$m, y as script$o, R as Ripple, x as script$r, v as script$s, s as script$u, z as FocusTrap, q as script$y, A as script$D, C as FilterMatchMode, F as FilterService, D as FilterOperator } from './server.mjs';
import { g as getVNodeProp, _ as _default, C as ConnectedOverlayScrollHandler } from './index5.mjs';
...
import script$E from './index247.mjs';
import script$n from './index252.mjs';
import { style } from '@primeuix/styles/datatable';
import { s as script$q } from './index6.mjs';
import { s as script$p } from './index8.mjs';
import { s as script$t } from './index19.mjs';
import { O as OverlayEventBus } from './index10.mjs';
import script$v from './index24.mjs';
import script$w from './index227.mjs';
import { ZIndex } from '@primeuix/utils/zindex';
import { s as script$x } from './index21.mjs';
import script$z from './index230.mjs';
import { s as script$A, a as script$B, b as script$C } from './index30.mjs';
import '../_/nitro.mjs';
import 'nodemailer';
import 'node:crypto';
import 'node:http';
  ...
  methods: {
    ...
    onRowKeyDown: function onRowKeyDown2(e, slotProps) {
      ...
      if (this.selectionMode) {
        ...
        switch (event.code) {
          case "ArrowDown":
            this.onArrowDownKey(event, row, rowIndex2, slotProps);
            break;
          case "ArrowUp":
            this.onArrowUpKey(event, row, rowIndex2, slotProps);
            break;
          case "Home":
            this.onHomeKey(event, row, rowIndex2, slotProps);
            break;
          case "End":
            this.onEndKey(event, row, rowIndex2, slotProps);
            break;
          case "Enter":
          case "NumpadEnter":
    ...
    onArrowDownKey: function onArrowDownKey(event, row, rowIndex2, slotProps) {
    ...
    onArrowUpKey: function onArrowUpKey(event, row, rowIndex2, slotProps) {
    ...
    onHomeKey: function onHomeKey(event, row, rowIndex2, slotProps) {
    ...
    onEndKey: function onEndKey(event, row, rowIndex2, slotProps) {
