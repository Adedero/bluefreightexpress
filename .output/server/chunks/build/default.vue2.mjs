...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_Logo, { color: "#fff" }, null, _parent));
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    class: "flex items-center gap-2 text-xs font-semibold px-3 py-1 bg-white/40 hover:bg-white/50 transition-colors rounded-full"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span${_scopeId}>Back to website</span>`);
  ...
  _push(`</header><footer class="px-3 pt-1 pb-5 text-white"><h1 class="text-center rubik text-3xl">Admin Panel</h1><p class="text-sm text-center">Made with Nuxt</p></footer><img${ssrRenderAttr("src", _imports_0)} class="absolute -z-[1] top-0 left-0 w-full h-full object-cover brightness-[0.7]"></div><div class="md:col-span-3 lg:col-span-1 flex items-center justify-center px-4 py-8">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/auth/default.vue");
