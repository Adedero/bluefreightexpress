...
const ocean_freight = "" + __buildAssetsURL("ocean-freight.De-yiPm3.jpg");

const air_freight = "" + __buildAssetsURL("air-freight._tpWwtrb.jpg");

const warehousing = "" + __buildAssetsURL("warehousing.DBxumjN7.jpg");

const local_shipping = "" + __buildAssetsURL("local-shipping.BoR0q-Ae.jpg");

const warehouse_and_distribution = "" + __buildAssetsURL("warehouse-_-distribution.MFE1E3R0.jpg");

const contract_logistics = "" + __buildAssetsURL("contract-logistics.DUf05ZNN.jpg");

const specialized_transport = "" + __buildAssetsURL("specilaized-transport.BPYZ_nMy.jpg");
...
const services = [
  ...
  },
  {
    ...
    content: {
      ...
      conclusion: "Blue Freight Express is more than just a logistics provider—we are a partner in your supply chain success. Our warehousing solutions ensure that your goods are stored securely, managed efficiently, and distributed seamlessly. Let us handle the logistics so you can focus on growing your business."
    }
  },
  {
    id: 4,
