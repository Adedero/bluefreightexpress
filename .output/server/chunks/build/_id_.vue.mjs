...
import { p as priorities, o as orderStatuses, f as freightModes, d as deliveryModes, t as trackingUpdateSeverities } from './index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const shouldDisableDeliverySaveBtn = computed(() => {
      var _a, _b, _c, _d, _e;
      const hasChanged = updatedOrder.value.priority !== ((_a = order.value) == null ? void 0 : _a.priority) || updatedOrder.value.status !== ((_b = order.value) == null ? void 0 : _b.status) || updatedOrder.value.freightMode !== ((_c = order.value) == null ? void 0 : _c.freightMode) || updatedOrder.value.deliveryMode !== ((_d = order.value) == null ? void 0 : _d.deliveryMode) || updatedOrder.value.estimatedDelivery !== ((_e = order.value) == null ? void 0 : _e.estimatedDelivery);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(order)) {
        ...
        _push(ssrRenderComponent(_component_PrimeFieldset, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<!--]--><div class="flex items-center gap-2"${_scopeId}><span${_scopeId}>Total Price: </span><span class="font-bold"${_scopeId}>$${ssrInterpolate(unref(updatedOrder).totalPrice.toLocaleString())}</span></div><div class="flex justify-end gap-2"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_PrimeButton, {
                onClick: resetItems,
                label: "Reset",
                icon: "pi pi-replay",
              ...
              return [
                createVNode("section", { class: "bg-[--p-surface-50] rounded-md p-2 grid gap-4" }, [
                  ...
                  createVNode("div", { class: "flex items-center gap-2" }, [
                    ...
                    createVNode("span", { class: "font-bold" }, "$" + toDisplayString(unref(updatedOrder).totalPrice.toLocaleString()), 1)
                  ]),
                  createVNode("div", { class: "flex justify-end gap-2" }, [
                    createVNode(_component_PrimeButton, {
                      onClick: resetItems,
        ...
        _push(ssrRenderComponent(_component_PrimeFieldset, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<section class="bg-[--p-surface-50] rounded-md p-2 grid gap-4"${_scopeId}><div class="grid md:grid-cols-6 lg:grid-cols-5 gap-2"${_scopeId}><div class="grid form-control md:col-span-2 lg:col-span-1"${_scopeId}><label${_scopeId}>Priority <span class="text-red-500"${_scopeId}>*</span></label>`);
              _push2(ssrRenderComponent(_component_PrimeSelect, {
                modelValue: unref(updatedOrder).priority,
                "onUpdate:modelValue": ($event) => unref(updatedOrder).priority = $event,
                options: unref(priorities)
              }, null, _parent2, _scopeId));
              _push2(`</div><div class="grid form-control md:col-span-2 lg:col-span-1"${_scopeId}><label${_scopeId}>Order Status <span class="text-red-500"${_scopeId}>*</span></label>`);
              _push2(ssrRenderComponent(_component_PrimeSelect, {
                modelValue: unref(updatedOrder).status,
                "onUpdate:modelValue": ($event) => unref(updatedOrder).status = $event,
                options: unref(orderStatuses)
              }, null, _parent2, _scopeId));
              _push2(`</div><div class="grid form-control md:col-span-2 lg:col-span-1"${_scopeId}><label${_scopeId}>Freight Mode <span class="text-red-500"${_scopeId}>*</span></label>`);
              _push2(ssrRenderComponent(_component_PrimeSelect, {
              ...
              _push2(`</div><div class="grid form-control md:col-span-3 lg:col-span-1"${_scopeId}><label${_scopeId}>Delivery Mode <span class="text-red-500"${_scopeId}>*</span></label>`);
              _push2(ssrRenderComponent(_component_PrimeSelect, {
              ...
              _push2(`</div><div class="grid form-control md:col-span-3 lg:col-span-1"${_scopeId}><label${_scopeId}>Estimated Delivery Date <span class="text-red-500"${_scopeId}>*</span></label>`);
              ...
              return [
                createVNode("section", { class: "bg-[--p-surface-50] rounded-md p-2 grid gap-4" }, [
                  createVNode("div", { class: "grid md:grid-cols-6 lg:grid-cols-5 gap-2" }, [
                    ...
                    createVNode("div", { class: "grid form-control md:col-span-3 lg:col-span-1" }, [
                      createVNode("label", null, [
