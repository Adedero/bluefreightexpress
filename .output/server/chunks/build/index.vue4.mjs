import { a as script, s as script$1, e as useNuxtApp, u as useToast, _ as __nuxt_component_0 } from './server.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  `;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-676ebfda><div class="form-control" data-v-676ebfda><label for="full-name" data-v-676ebfda>Full Name *</label><input type="text" id="full-name"${ssrRenderAttr("value", unref(contact).name)} placeholder="John Doe" class="my-input" data-v-676ebfda>`);
      if ((_b = (_a = unref(validationResult)) == null ? void 0 : _a.error) == null ? void 0 : _b.formErrors.fieldErrors.name) {
        _push(`<small class="text-accent" data-v-676ebfda>${ssrInterpolate((_c = unref(validationResult).error.formErrors.fieldErrors.name) == null ? void 0 : _c[0])}</small>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="form-control" data-v-676ebfda><label for="phone-number" data-v-676ebfda>Phone Number *</label><input type="text" id="phone-number"${ssrRenderAttr("value", unref(contact).phoneNumber)} placeholder="+1234567890" class="my-input" data-v-676ebfda>`);
      if ((_e = (_d = unref(validationResult)) == null ? void 0 : _d.error) == null ? void 0 : _e.formErrors.fieldErrors.phoneNumber) {
        _push(`<small class="text-accent" data-v-676ebfda>${ssrInterpolate((_f = unref(validationResult).error.formErrors.fieldErrors.phoneNumber) == null ? void 0 : _f[0])}</small>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="form-control md:col-span-2" data-v-676ebfda><label for="email" data-v-676ebfda>Email *</label><input type="email" id="email"${ssrRenderAttr("value", unref(contact).email)} placeholder="johndoe@example.com" class="my-input" data-v-676ebfda>`);
      if ((_h = (_g = unref(validationResult)) == null ? void 0 : _g.error) == null ? void 0 : _h.formErrors.fieldErrors.email) {
        _push(`<small class="text-accent" data-v-676ebfda>${ssrInterpolate((_i = unref(validationResult).error.formErrors.fieldErrors.email) == null ? void 0 : _i[0])}</small>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="form-control" data-v-676ebfda><label for="country" data-v-676ebfda>Country *</label><input type="text" id="country"${ssrRenderAttr("value", unref(contact).country)} placeholder="e.g. USA" class="my-input" data-v-676ebfda>`);
      if ((_k = (_j = unref(validationResult)) == null ? void 0 : _j.error) == null ? void 0 : _k.formErrors.fieldErrors.country) {
        _push(`<small class="text-accent" data-v-676ebfda>${ssrInterpolate((_l = unref(validationResult).error.formErrors.fieldErrors.country) == null ? void 0 : _l[0])}</small>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="form-control" data-v-676ebfda><label for="city" data-v-676ebfda>City *</label><input type="text" id="city"${ssrRenderAttr("value", unref(contact).city)} placeholder="e.g. New York" class="my-input" data-v-676ebfda>`);
      if ((_n = (_m = unref(validationResult)) == null ? void 0 : _m.error) == null ? void 0 : _n.formErrors.fieldErrors.city) {
        _push(`<small class="text-accent" data-v-676ebfda>${ssrInterpolate((_o = unref(validationResult).error.formErrors.fieldErrors.city) == null ? void 0 : _o[0])}</small>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="form-control md:col-span-2" data-v-676ebfda><label for="subject" data-v-676ebfda>Subject *</label><input type="text" id="subject"${ssrRenderAttr("value", unref(contact).subject)} placeholder="e.g. Quote Request" class="my-input" data-v-676ebfda>`);
      if ((_q = (_p = unref(validationResult)) == null ? void 0 : _p.error) == null ? void 0 : _q.formErrors.fieldErrors.subject) {
        _push(`<small class="text-accent" data-v-676ebfda>${ssrInterpolate((_r = unref(validationResult).error.formErrors.fieldErrors.subject) == null ? void 0 : _r[0])}</small>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="form-control md:col-span-2" data-v-676ebfda><label for="message" data-v-676ebfda>Message *</label><textarea id="message" rows="6" placeholder="Your message goes here" class="my-input" data-v-676ebfda>${ssrInterpolate(unref(contact).message)}</textarea>`);
      if ((_t = (_s = unref(validationResult)) == null ? void 0 : _s.error) == null ? void 0 : _t.formErrors.fieldErrors.message) {
        _push(`<small class="text-accent" data-v-676ebfda>${ssrInterpolate((_u = unref(validationResult).error.formErrors.fieldErrors.message) == null ? void 0 : _u[0])}</small>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="flex items-center justify-center md:col-span-2 mt-4" data-v-676ebfda>`);
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-676ebfda"]]);

const _imports_0 = "" + __buildAssetsURL("contact-us.XwfrBarW.jpg");

const orgData = {
  email: "contact@bluefreightexpress.com",
  address: "",
  city: "",
  state: "",
  country: "Switzerland",
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, { name: "main-default" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><p class="text-sm font-medium text-center"${_scopeId}>${ssrInterpolate(unref(orgData).email)}</p></div><div class="flex flex-col items-center justify-center gap-1"${_scopeId}><div class="aspect-square p-6 rounded-full bg-primary-400 grid place-content-center"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
              name: "lucide:clock",
              size: "1.75rem"
            }, null, _parent2, _scopeId));
            _push2(`</div><p class="text-sm font-medium text-center whitespace-pre-wrap"${_scopeId}>${ssrInterpolate(unref(orgData).openHours)}</p></div></div><div class="mt-10 w-full"${_scopeId}>`);
                ...
                createVNode("div", { class: "max-w-[54rem] bg-primary-500 text-white py-12 px-6 md:py-16 md:px-24 flex flex-col gap-5 items-center justify-center" }, [
                  ...
                  createVNode("div", { class: "w-full grid md:grid-cols-2 gap-12" }, [
                    createVNode("div", { class: "flex flex-col items-center justify-center gap-1" }, [
                      ...
                      createVNode("p", { class: "text-sm font-medium text-center" }, toDisplayString(unref(orgData).email), 1)
                    ]),
                    createVNode("div", { class: "flex flex-col items-center justify-center gap-1" }, [
                      createVNode("div", { class: "aspect-square p-6 rounded-full bg-primary-400 grid place-content-center" }, [
                        createVNode(_component_Icon, {
                      ...
                      createVNode("p", { class: "text-sm font-medium text-center whitespace-pre-wrap" }, toDisplayString(unref(orgData).openHours), 1)
                    ])
                  ]),
